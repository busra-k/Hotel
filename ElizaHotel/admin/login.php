        ...
        <div class="jumbotron">
            ...
            <form action="" method="post" name="login">
                <div class="form-group">
                    <label for="emailusername">Kullanıcı adı veya E-mail:</label>
                ...
                <button type="submit" name="submit" value="Login" onclick="retrun(submitlogin());" class="btn btn-lg btn-primary btn-block">Giriş</button>
                
                <br>
                <p style="text-align: center; font-size: 14px;"><a href="../index.php">Anasayfaya Dön</a></p>
